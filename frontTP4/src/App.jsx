    ...
    return (
        <ContextoSimulacionHandler>
            <div className="container-fluid body">
                ...
                <button onClick={() => setShowStateTable(true)} className="btn btn-secondary">
                    Tabla de estados</button>
                <button onClick={() => setShowStateTable(false)} className="btn btn-secondary">
                    Tabla de RK</button>
